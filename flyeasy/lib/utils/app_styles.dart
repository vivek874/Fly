...
Color primary = const Color(0xFF687daf);      //can directly call this color
class Styles{                                //need to call using Styles.xxx
  static Color primaryColor = primary;
  static Color textColor = const Color(0xFF3b3b3b);
  static Color bgColor = const Color(0xFFeeedf2);
  static Color orangeColor = const Color(0xFF526799);
  static TextStyle textStyle = TextStyle(fontSize: 16, fontStyle:FontStyle.italic, color: textColor,fontWeight: FontWeight.w500);
